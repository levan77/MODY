...
// ── PLATFORM SETTINGS ─────────────────────────────────────────
var settings = { promo_enabled: true, nail_colors_enabled: true, commission: 5, platform_fee: 5, chat_enabled: true, pro_registration_enabled: true, reviews_enabled: true, auto_accept: false, min_order: 0, cancel_hours: 2, brand_name: "AMODY", open_time: "10:00", close_time: "20:00", advance_days: 30, email_notifications: true, sms_notifications: false };
...
async function loadSettings() {
  ...
  var sbn = ge("setBrandName");  if (sbn) sbn.value = settings.brand_name || "AMODY";
